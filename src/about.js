...
export default()=>{
    return(
        ...
        <div className="about-discription">Hi! I'm João Monteiro
         ...
         I have experience with JavaScript, ReactJS, CSS, HTML, Jira and GitHub.<br/>
         When I'm not coding, you can find me in the ocean trying to catch the perfect wave or in
          a kitchen inventing some recipes.
          </div>
        </div>
    )
}