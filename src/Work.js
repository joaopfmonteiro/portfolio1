        ...
        <div className='react'>
            <div className='react-work'>
                <div className='netflix'>
                    <div className='netflixFront'onClick={() => setButtonPopup1(true)}><img src="https://firebasestorage.googleapis.com/v0/b/portfolio-cff15.appspot.com/o/1.png?alt=media&token=07191321-d285-4071-8f32-a4ff883c64f7"/></div>
                ...
                <div className='hoqueiflix'>
                    <div className='hoqueiflixFront'onClick={() => setButtonPopup2(true)}><img src="https://firebasestorage.googleapis.com/v0/b/portfolio-cff15.appspot.com/o/2.png?alt=media&token=c0d91130-58e2-4ef6-9c46-035832c0f37f"/></div>
